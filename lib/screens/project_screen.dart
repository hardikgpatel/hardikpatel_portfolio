...
class _ProjectScreenState extends State<ProjectScreen> {
  List<ProjectModel> projects = [
    ProjectModel(
      ...
      link: 'https://play.google.com/store/apps/details?id=com.infobizzs.kaizen',
    ),
    ProjectModel(
      name: 'La benito',
      image:
      ...
      link: 'https://play.google.com/store/apps/details?id=com.redspark.labenito',
    ),
    ProjectModel(
      name: 'OSI',
      image:
    ...
    ProjectModel(
      ...
      link: 'https://play.google.com/store/apps/details?id=com.fqa.flipkartquizanswer',
    ),
    ProjectModel(
      name: 'Nexnos Life Delivery',
      image:
      'https://cdn-images-1.medium.com/max/1200/1*5-aoK8IBmXve5whBQM90GA.png',
      description:
